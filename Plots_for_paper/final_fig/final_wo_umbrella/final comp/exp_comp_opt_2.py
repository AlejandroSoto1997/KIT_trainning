...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 15 14:17:43 2024
...
df_YL1_L4_L5_L6 = pd.read_csv("YL1_L4_L5_L6_Y+L0.csv")
...
# Definir las columnas de interés, incluyendo Y+L0
columns_of_interest = {
    'L0': {'h': (0, 1), 'c': (2, 3)},
    'L1': {'h': (12, 13), 'c': (14, 15)},
    'L2': {'h': (0, 1), 'c': (2, 3)},
    ...
    'L5': {'h': (20, 21), 'c': (22, 23)},
    'L6': {'h': (24, 25), 'c': (26, 27)},
    'Y+L0': {'h': (28, 29), 'c': (30, 31)},  # Actualizado con las columnas correctas para Y+L0
    'Y': {'h': (0, 1), 'c': (2, 3)},
}
fusion_temperatures = []
error_bars = []
...
# Ajustar el tamaño y la posición de la barra de colores
cbar_ax = fig.add_axes([0.72, 0.114, 0.25, 0.03])  # [left, bottom, width, height]

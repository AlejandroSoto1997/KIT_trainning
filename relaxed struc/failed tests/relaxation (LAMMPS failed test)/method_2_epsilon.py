...
plt.axhline(y=recommended_epsilon, color='red', linestyle='--', label='Recommended Epsilon')
...
plt.subplot(1, 2, 2)
avg_distances = calculate_kn_distance(positions, 119)  # Distances to the 4th nearest neighbor
plt.hist(avg_distances, bins=20)
plt.title('Histogram of Average Distances to the Nearest Neighbor')
